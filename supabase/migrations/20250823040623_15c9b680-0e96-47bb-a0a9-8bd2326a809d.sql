-- Create a demo profile first, then add sample projects
-- Insert a demo seller profile
INSERT INTO public.profiles (user_id, display_name, role)
VALUES (gen_random_uuid(), 'Demo Developer', 'seller')
ON CONFLICT (user_id) DO NOTHING;

-- Add sample projects with the demo seller
...
(
  ...
  'approved',
  (SELECT user_id FROM public.profiles WHERE display_name = 'Demo Developer' LIMIT 1),
  '/placeholder.svg',
